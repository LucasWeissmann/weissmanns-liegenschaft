...
export default function DeleteConfirm({ booking, onDelete, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm bg-white rounded-3xl p-6 shadow-2xl animate-scale-in text-center"
      ...
      >
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={deleting}
            className="flex-1 py-3.5 rounded-2xl bg-gradient-to-r from-rose-500 to-rose-600 text-white font-bold shadow-lg shadow-rose-500/25 disabled:opacity-40 active:scale-[0.98] transition-all"
          >
